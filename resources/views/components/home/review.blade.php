    ...
    <div class="cta-gradient py-20 lg:py-28">
        ...
        <div class="reveal relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url('/booking') }}" class="inline-flex items-center justify-center gap-2 bg-white text-primary px-8 py-4 rounded-xl font-headline font-bold text-base hover:bg-slate-50 transition-all duration-300 active:scale-95 shadow-xl">
